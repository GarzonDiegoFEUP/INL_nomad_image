...
```sh
curl -L -o nomad-oasis.zip "curl -L -o nomad-oasis.zip "[https://github.com/nomad-hzb/hzb_chemical_energy_image/raw/main/nomad-oasis.zip](https://github.com/GarzonDiegoFEUP/INL_nomad_image/raw/main/nomad-oasis.zip)"
```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/hzb_chemical_energy_image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/hzb_chemical_energy_image/manifests/main": unauthorized`
